...
published by IBM for churn-analysis tutorials); it is small enough
(~950 KB) to redistribute here for reproducibility, and is included at
...
This downloads nothing (the dataset is already in `data/`), runs the full
cross-validated comparison described above, and writes
